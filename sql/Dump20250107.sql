...
--
-- Table structure for table `hr_survey`
--

DROP TABLE IF EXISTS `hr_survey`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hr_survey` (
  `survey_id` int NOT NULL AUTO_INCREMENT,
  `survey_description` varchar(100) DEFAULT NULL,
  `survey_url` varchar(45) DEFAULT NULL,
  `survey_name` varchar(100) DEFAULT NULL,
  `top_menu_list_jsonData` TEXT DEFAULT NULL,
  `year` int DEFAULT NULL,
  PRIMARY KEY (`survey_id`),
  KEY `common_info_survey_idx` (`year`),
  CONSTRAINT `common_info_survey` FOREIGN KEY (`year`) REFERENCES `hr_survey_common_info` (`year`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `hr_survey`
--

LOCK TABLES `hr_survey` WRITE;
/*!40000 ALTER TABLE `hr_survey` DISABLE KEYS */;
INSERT INTO `hr_survey` VALUES (9,'개발','hrd_2024','제 24회 인재개발 실태조사','{\"top_menuList\": [\" Ⅰ. 2023년도 교육관련 지표\", \"Ⅱ. HRD 현황\", \"Ⅲ. HRD 활동\", \"123\"]}',2024),(10,'채용','hrm_2024','제 25회 인재채용 실태조사','{\"top_menuList\": [\"Ⅰ. 테이블\", \"Ⅱ. 객관식\", \"Ⅲ. 텍스트\"]}',2024),(11,'개발','hrd_2025','제 25회 인재개발 실태조사','{\"top_menuList\": [\" Ⅰ. 2023년도 교육관련 지표\", \"Ⅱ. HRD 현황\", \"Ⅲ. HRD 활동\", \"123\"]}',2025),(12,'채용','hrm_2025','제 26회 인재채용 실태조사','{\"top_menuList\": [\"Ⅰ. 테이블\", \"Ⅱ. 객관식\", \"Ⅲ. 텍스트\"]}',2025);
/*!40000 ALTER TABLE `hr_survey` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hr_survey_common_info`
--

DROP TABLE IF EXISTS `hr_survey_common_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hr_survey_common_info` (
  `year` int NOT NULL,
...
--
-- Dumping data for table `hr_survey_common_info`
--

LOCK TABLES `hr_survey_common_info` WRITE;
/*!40000 ALTER TABLE `hr_survey_common_info` DISABLE KEYS */;
INSERT INTO `hr_survey_common_info` VALUES (2024,'#efefef','2024-07-26 14:00:00','2024-12-31 14:00:00'),(2025,'#efefef','2025-01-01 15:56:22','2025-12-31 15:56:22');
/*!40000 ALTER TABLE `hr_survey_common_info` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hr_survey_common_result`
--

DROP TABLE IF EXISTS `hr_survey_common_result`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hr_survey_common_result` (
  ...
  `progress_raw` TEXT DEFAULT NULL,
  `complete` tinyint(1) DEFAULT '0',
  `survey_id` int DEFAULT NULL,
  PRIMARY KEY (`result_id`),
  KEY `FK_survey_TO_common_result_1` (`survey_id`),
  CONSTRAINT `FK_survey_TO_common_result_1` FOREIGN KEY (`survey_id`) REFERENCES `hr_survey` (`survey_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `hr_survey_common_result`
--

LOCK TABLES `hr_survey_common_result` WRITE;
/*!40000 ALTER TABLE `hr_survey_common_result` DISABLE KEYS */;
INSERT INTO `hr_survey_common_result` VALUES (1,'한호성','ㅁㄴㅁㄹㅇㄴㅁ','021231234','01012341234','32229','충남 홍성군 홍성읍 조양로 40','12321','test1@naver.com','2','213','12321','2','','5378502360','21321','12','','','','','','','','','123132','[true, true, true]',1,10);
/*!40000 ALTER TABLE `hr_survey_common_result` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hr_survey_page_result`
--

DROP TABLE IF EXISTS `hr_survey_page_result`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hr_survey_page_result` (
  ...
  CONSTRAINT `FK_common_result_TO_page_result_1` FOREIGN KEY (`result_id`) REFERENCES `hr_survey_common_result` (`result_id`),
  CONSTRAINT `FK_page_survey_TO_page_result_1` FOREIGN KEY (`p_survey_id`) REFERENCES `hr_survey_page_survey` (`p_survey_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `hr_survey_page_result`
--

LOCK TABLES `hr_survey_page_result` WRITE;
/*!40000 ALTER TABLE `hr_survey_page_result` DISABLE KEYS */;
INSERT INTO `hr_survey_page_result` VALUES (4,'{\"R_1_etc\": null, \"R_1_multi\": \"3\", \"R_2_multi\": \"3,1\"}',12,1),(5,'{\"R_1_1_3\": 12, \"R_1_1_4\": 0, \"R_1_2_3\": 88, \"R_1_2_4\": 100, \"R_2_1_2\": 100, \"R_2_1_3\": 0, \"R_2_2_2\": null, \"R_2_2_3\": 100, \"R_3_1_3\": \"2\", \"R_3_2_3\": \"2\", \"R_3_3_3\": \"2\", \"R_4_1_3\": \"3\", \"R_4_1_4\": \"2\", \"R_4_2_3\": \"3\", \"R_4_2_4\": \"2\", \"R_4_3_3\": \"3\", \"R_4_3_4\": \"2\", \"R_5_1_3\": 12, \"R_5_2_3\": \"121-1\", \"R_5_3_3\": 112, \"R_5_4_3\": 1212, \"R_5_5_3\": 12, \"R_6_n_2\": \"9\", \"R_9_n_3_b\": \"3\", \"R_9_n_3_f\": \"3\", \"R_7_n_3_rad\": \"4\", \"R_8_n_3_che\": \"2,3\", \"R_10_1_3_bWei\": \"1\", \"R_10_2_3_bWei\": null, \"R_10_3_3_bWei\": null, \"R_10_4_3_bWei\": null, \"R_10_n_3_fWei\": \"1\"}',8,1),(6,'{\"R_1_etc\": \"12312123\", \"R_2_etc\": null}',13,1);
/*!40000 ALTER TABLE `hr_survey_page_result` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hr_survey_page_survey`
--

DROP TABLE IF EXISTS `hr_survey_page_survey`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hr_survey_page_survey` (
...
-- Dump completed on 2025-01-07 17:13:46
